...
| Capa | Tecnología |
|---|---|
| Backend | Laravel 12, PHP 8.3 (mínimo requerido: 8.2, pero local y VPS corren 8.3) |
...
# Local y VPS corren PHP 8.3: /c/laragon/bin/php/php-8.3.0-Win32-vs16-x64/php.exe
php artisan serve                    # desde terminal de Laragon (verificar que apunte a PHP 8.3)
...
| `PHP version >= 8.2.0 required` | PATH apunta a PHP 8.1 | Usar terminal de Laragon o ruta completa a PHP 8.3 |
