...
class TiposAprobacionSeeder extends Seeder
{
    public function run(): void
    {
        $tipos = [
            ...
            ['clave' => 'devolucion_mercaderia', 'nombre' => 'Devolución de Mercadería', 'descripcion' => 'Devolución de productos', 'activo' => true],
            ['clave' => 'baja_activo', 'nombre' => 'Baja de Activo', 'descripcion' => 'Dar de baja un activo fijo', 'activo' => true],
            ['clave' => 'transferencia_bodega', 'nombre' => 'Transferencia de Bodega', 'descripcion' => 'Transferencia de stock entre bodegas', 'activo' => true],
            ['clave' => 'ajuste_inventario', 'nombre' => 'Ajuste de Inventario', 'descripcion' => 'Ajuste manual de inventario', 'activo' => true],
            ['clave' => 'modificacion_asiento', 'nombre' => 'Modificación de Asiento', 'descripcion' => 'Modificación de asiento contable aprobado', 'activo' => true],
