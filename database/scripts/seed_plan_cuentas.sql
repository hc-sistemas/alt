...
-- Plan de Cuentas NIIF + Ejercicios Contables 2026 — Altamira Light & Sound
--
-- Uso: psql -U postgres -d altamira -f seed_plan_cuentas.sql
-- Idempotente: seguro ejecutar múltiples veces (ON CONFLICT DO NOTHING).
--
-- Diseño:
--   plan_cuentas.codigo es UNIQUE global → plan compartido, empresa_id = NULL.
--   padre_id se resuelve dinámicamente con regexp, no hardcodeado.
...
-- ---------------------------------------------------------------------------
-- 0. Limpiar tablas para re-inserción limpia
-- ---------------------------------------------------------------------------
TRUNCATE ejercicios_contables CASCADE;
TRUNCATE plan_cuentas CASCADE;
...
('1.1.1.5',     'Dinero Electrónico / Pasarelas de Pago',                    'activo'),
('1.1.2',       'Inversiones Financieras a Corto Plazo',                      'activo'),
('1.1.2.1',     'Inversiones a Costo Amortizado (Pólizas / DPFs)',           'activo'),
...
('1.1.3.4',     'Préstamos y Anticipos a Empleados',                         'activo'),
('1.1.3.5',     '(-) Provisión Cuentas Incobrables',                         'activo'),
('1.1.4',       'Inventarios',                                                'activo'),
('1.1.4.1',     'Inventario de Mercadería',                                   'activo'),
('1.1.4.2',     'Inventario de Materia Prima y Suministros',                  'activo'),
('1.1.4.3',     'Inventario en Tránsito',                                    'activo'),
('1.1.4.4',     '(-) Provisión por Deterioro de Inventarios',                'activo'),
('1.1.5',       'Activos por Impuestos Corrientes',                           'activo'),
('1.1.5.1',     'Crédito Tributario por IVA',                                'activo'),
('1.1.5.2',     'Crédito Tributario por Retenciones de IVA',                 'activo'),
('1.1.5.3',     'Crédito Tributario por Retenciones de Impuesto a la Renta', 'activo'),
...
('1.2.1.6',     'Equipos de Computación',                                    'activo'),
('1.2.1.7',     'Vehículos y Equipos de Transporte',                         'activo'),
('1.2.1.8',     'Repuestos y Herramientas',                                   'activo'),
('1.2.1.9',     'Construcciones en Curso',                                    'activo'),
('1.2.1.10',    '(-) Depreciación Acumulada de PPE',                         'activo'),
...
('1.2.1.10.5',  '(-) Dep. Acum. Equipos de Computación',                    'activo'),
('1.2.1.10.6',  '(-) Dep. Acum. Vehículos',                                 'activo'),
('1.2.1.11',    '(-) Deterioro Acumulado de PPE',                            'activo'),
('1.2.2',       'Propiedades de Inversión',                                  'activo'),
('1.2.2.1',     'Terrenos (Inversión)',                                       'activo'),
('1.2.2.2',     'Edificios (Inversión)',                                      'activo'),
('1.2.2.3',     '(-) Depreciación Acumulada de Propiedades de Inversión',   'activo'),
('1.2.3',       'Activos Intangibles',                                        'activo'),
('1.2.3.1',     'Software y Licencias',                                       'activo'),
('1.2.3.2',     'Marcas y Patentes',                                          'activo'),
('1.2.3.3',     '(-) Amortización Acumulada de Intangibles',                 'activo'),
...
('1.2.5.3',     '(-) Provisión Cuentas Incobrables a Largo Plazo',          'activo'),
...
('2.1.2.1',     'Préstamos Bancarios a Corto Plazo',                         'pasivo'),
('2.1.2.2',     'Tarjetas de Crédito Corporativas',                          'pasivo'),
('2.1.3',       'Obligaciones con la Administración Tributaria',              'pasivo'),
...
('2.1.4.1',     'Nómina por Pagar',                                          'pasivo'),
('2.1.4.2',     'Obligaciones con el IESS - Aporte Patronal',                'pasivo'),
('2.1.4.3',     'Obligaciones con el IESS - Aporte Personal',                'pasivo'),
('2.1.4.4',     'Obligaciones con el IESS - Préstamos',                      'pasivo'),
('2.1.4.5',     'Décimo Tercer Sueldo por Pagar',                            'pasivo'),
('2.1.4.6',     'Décimo Cuarto Sueldo por Pagar',                            'pasivo'),
...
('2.1.5.1',     'Préstamos de Accionistas a Corto Plazo',                    'pasivo'),
('2.1.5.2',     'Dividendos por Pagar',                                       'pasivo'),
('2.1.6',       'Otros Pasivos Corrientes',                                   'pasivo'),
('2.1.6.1',     'Porción Corriente de Obligaciones a Largo Plazo',           'pasivo'),
...
('2.2.2.1',     'Préstamos Bancarios a Largo Plazo',                         'pasivo'),
...
('2.2.4.1',     'Préstamos de Accionistas a Largo Plazo',                    'pasivo'),
('2.2.4.2',     'Pasivos por Arrendamientos a Largo Plazo',                  'pasivo'),
('2.2.5',       'Provisiones a Largo Plazo',                                  'pasivo'),
('2.2.5.1',     'Provisión para Jubilación Patronal',                        'pasivo'),
('2.2.5.2',     'Provisión para Desahucio',                                  'pasivo'),
('2.2.5.3',     'Provisión por Garantías de Productos',                      'pasivo'),
('2.2.5.4',     'Provisión por Litigios y Demandas',                         'pasivo'),
...
('3.1.3.01',    'Superávit por Revaluación de PPE',                          'patrimonio'),
('3.1.3.02',    'Ganancias y Pérdidas Actuariales',                          'patrimonio'),
('3.1.4',       'Resultados Acumulados',                                      'patrimonio'),
('3.1.4.01',    'Ganancias Acumuladas',                                       'patrimonio'),
('3.1.4.02',    '(-) Pérdidas Acumuladas',                                   'patrimonio'),
('3.1.4.03',    'Resultados Acumulados por Adopción NIIF',                   'patrimonio'),
('3.1.5',       'Resultados del Periodo',                                     'patrimonio'),
('3.1.5.01',    'Utilidad del Periodo',                                       'patrimonio'),
('3.1.5.02',    '(-) Pérdida del Periodo',                                   'patrimonio'),
...
('4.1.1.01',    'Venta de Mercaderías Locales',                              'ingreso'),
('4.1.1.02',    'Venta de Mercaderías al Exterior',                          'ingreso'),
('4.1.2',       'Prestación de Servicios',                                   'ingreso'),
('4.1.2.01',    'Ingresos por Servicios Técnicos y Mantenimiento',           'ingreso'),
('4.1.2.02',    'Ingresos por Servicios de Capacitación y Asesorías',        'ingreso'),
...
-- ============================================================
('5',           'Gastos',                                                     'gasto'),
('5.1',         'Costo de Ventas y Producción',                              'gasto'),
('5.1.1',       'Costo de Ventas',                                            'gasto'),
('5.1.1.1',     'Costo de Ventas de Mercaderías Locales',                    'gasto'),
('5.1.1.2',     'Costo de Ventas de Mercaderías Importadas',                 'gasto'),
('5.1.1.3',     'Costo de Prestación de Servicios Técnicos',                 'gasto'),
...
('5.2.1.05',    'Décimo Tercer Sueldo',                                      'gasto'),
('5.2.1.06',    'Décimo Cuarto Sueldo',                                      'gasto'),
('5.2.1.07',    'Vacaciones',                                                 'gasto'),
('5.2.1.08',    'Fondos de Reserva',                                          'gasto'),
('5.2.1.09',    'Capacitación al Personal',                                   'gasto'),
('5.2.1.10',    'Uniformes y Equipos de Protección',                          'gasto'),
('5.2.2',       'Gastos Generales y Administrativos',                         'gasto'),
('5.2.2.01',    'Honorarios Profesionales y Asesorías',                      'gasto'),
('5.2.2.02',    'Arrendamientos de Locales y Bodegas',                       'gasto'),
('5.2.2.03',    'Servicios Básicos',                                          'gasto'),
('5.2.2.04',    'Mantenimiento y Reparación de Instalaciones',                'gasto'),
('5.2.2.05',    'Mantenimiento y Reparación de Vehículos',                   'gasto'),
('5.2.2.06',    'Suministros y Materiales de Oficina',                        'gasto'),
('5.2.2.07',    'Gastos de Viaje, Movilización y Viáticos',                 'gasto'),
('5.2.2.08',    'Combustibles y Lubricantes',                                 'gasto'),
('5.2.2.09',    'Seguros de Vehículos y Mercadería',                         'gasto'),
('5.2.2.10',    'Impuestos, Tasas y Contribuciones',                          'gasto'),
('5.2.2.11',    'Publicidad, Marketing y Redes Sociales',                     'gasto'),
('5.2.3',       'Gastos de Depreciación y Amortización',                     'gasto'),
('5.2.3.01',    'Depreciación de Propiedades, Planta y Equipo',              'gasto'),
('5.2.3.02',    'Amortización de Activos Intangibles',                       'gasto'),
('5.2.4',       'Gastos por Provisiones',                                     'gasto'),
('5.2.4.01',    'Gasto por Cuentas Incobrables',                             'gasto'),
('5.2.4.02',    'Gasto Provisión Jubilación Patronal y Desahucio',           'gasto'),
('5.3',         'Gastos Financieros',                                         'gasto'),
('5.3.1',       'Gastos Financieros',                                         'gasto'),
('5.3.1.01',    'Intereses por Préstamos Bancarios',                         'gasto'),
...
('5.4.1.02',    'Pérdida en Venta de Activos Fijos',                         'gasto'),
('5.4.1.03',    'Otros Gastos Extraordinarios',                               'gasto');

-- ---------------------------------------------------------------------------
-- 2. Insertar en plan_cuentas (plan compartido: empresa_id = NULL)
--    nivel    = número de puntos en el código + 1
--    permite_asientos = TRUE solo si no hay cuentas hijas en el catálogo
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 3. Resolver padre_id dinámicamente
--    Para código 'A.B.C', el padre es el registro con código 'A.B'.
--    Solo actualiza filas cuyo padre_id todavía sea NULL (idempotente).
-- ---------------------------------------------------------------------------
UPDATE plan_cuentas pc
SET    padre_id = parent.id
FROM   plan_cuentas parent
WHERE  strpos(pc.codigo, '.') > 0                              -- tiene al menos un punto
  AND  parent.codigo = regexp_replace(pc.codigo, '\.[^.]+$', '') -- código del padre
  AND  pc.padre_id IS NULL;                                    -- no actualizar si ya está resuelto

-- ---------------------------------------------------------------------------
-- 4. Ejercicios contables 2026 — 12 meses × 2 empresas = 24 filas
-- ---------------------------------------------------------------------------
...
-- SELECT COUNT(*)                              FROM plan_cuentas WHERE padre_id IS NULL; -- 5 (raíces)
...
--  WHERE pc.padre_id IS NOT NULL AND p.id IS NULL;  -- debe retornar 0 (sin huérfanos)
--
-- Verificar encoding (octet_length = length en ASCII, octet_length > length donde hay tildes):
-- SELECT codigo, nombre, octet_length(nombre), length(nombre)
-- FROM plan_cuentas
-- WHERE codigo IN ('1.1.3.4', '1.1.5.2', '1.1.4.1')
-- ORDER BY codigo;
